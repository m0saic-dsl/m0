/**
 * Lexical utilities for token-walking m0 strings.
 *
 * These are local copies of the helpers from @m0saic/dsl's internal
 * m0saicLexUtils module, duplicated here to avoid depending on an
 * unexported internal path. The implementations are trivial and stable.
 */
