...
import { replaceNodeBySpan, type ReplaceNodeOptions } from "./replaceNodeBySpan";
 ...
 * immediately attached `{...}` block, or drop it via `opts.overlay`) are
 * handled by the span transform.
 *
